...
RSpec.describe 'post#show', type: :system do
  let!(:user_one) { User.create(name: 'Oscar', photo: 'https://robohash.org/1', bio: 'bio', post_counter: 0) }
  let!(:user_two) { User.create(name: 'Carlos', photo: 'https://robohash.org/1', bio: 'bio', post_counter: 0) }
